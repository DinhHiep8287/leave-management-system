...
Ngoài các chức năng nghiệp vụ cốt lõi, hệ thống còn có một số cải thiện phục vụ demo và kiểm thử local như tệp đính kèm cho đơn nghỉ, báo cáo tổng hợp nâng cao, lịch theo phòng ban và tinh chỉnh giao diện theo phản hồi sử dụng. Các nội dung này không làm thay đổi mục tiêu cốt lõi của báo cáo: trình bày một hệ thống web quản lý nghỉ phép có quy trình nghiệp vụ rõ ràng, kiến trúc triển khai được và có khả năng mở rộng theo các nguyên tắc thiết kế đã chọn.
