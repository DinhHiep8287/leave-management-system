...
Một số hướng cải thiện nhỏ có thể tiếp tục được xem xét trong quá trình demo local, ví dụ duy trì tệp đính kèm cho đơn nghỉ và tinh chỉnh giao diện theo phản hồi sử dụng. Các hướng này không làm thay đổi mục tiêu cốt lõi của báo cáo: trình bày một hệ thống web quản lý nghỉ phép có quy trình nghiệp vụ rõ ràng, kiến trúc triển khai được và có khả năng mở rộng theo các nguyên tắc thiết kế đã chọn.
