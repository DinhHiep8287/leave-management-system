...
Các nhóm chức năng trên tạo thành phạm vi nghiệp vụ cốt lõi của hệ thống. Những chức năng mở rộng như tệp đính kèm cho đơn nghỉ, phê duyệt nhiều cấp hoặc các kênh tích hợp khác có thể được bổ sung sau dựa trên cùng mô hình actor, dữ liệu và luồng xử lý.
...
Một số hướng mở rộng có thể xuất hiện trong quá trình phát triển tiếp theo, chẳng hạn hỗ trợ tệp đính kèm cho đơn nghỉ, phê duyệt nhiều cấp, bổ sung báo cáo nâng cao hoặc tích hợp với các hệ thống bên ngoài. Các hướng này không bị loại trừ khỏi định hướng thiết kế, nhưng không phải trọng tâm của phần phân tích yêu cầu hiện tại. Khi được triển khai, chúng có thể được mô tả như phần mở rộng của các nhóm chức năng đã nêu: quản lý đơn nghỉ, quản lý dữ liệu liên quan, phân quyền truy cập và lưu vết thao tác.
