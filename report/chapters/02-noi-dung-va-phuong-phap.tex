...
Các nhóm chức năng trên tạo thành phạm vi nghiệp vụ cốt lõi của hệ thống. Những cải thiện như tệp đính kèm cho đơn nghỉ trong môi trường demo local, lịch theo phòng ban và tối ưu UI/UX có thể được duy trì hoặc mở rộng sau dựa trên cùng mô hình actor, dữ liệu và luồng xử lý.
...
Một số hướng cải thiện có thể xuất hiện trong quá trình phát triển tiếp theo, chẳng hạn duy trì tệp đính kèm cho đơn nghỉ ở môi trường demo local, hoàn thiện lịch theo phòng ban hoặc tối ưu UI/UX. Các hướng này không phải trọng tâm của phần phân tích yêu cầu hiện tại, nhưng có thể được mô tả như phần mở rộng tự nhiên của các nhóm chức năng đã nêu: quản lý đơn nghỉ, quản lý dữ liệu liên quan, phân quyền truy cập, tổng hợp dữ liệu và lưu vết thao tác.
